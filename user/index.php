					...
					<div class="panel panel-default" style="padding: 20px;">
						<div class="panel-body">
							...
							<?php
								...
								if($safeDate=='0'){
									echo '<form target="" method="post"><button style="margin-top: 20px;" name="date" id="save_the_life" type="submit" class="btn btn-lg btn-danger center-aligned ">Save The Life</button></form>';
								}
								else{
								...
								<span>You Already Safe the life. You will donate the blood after three months. We are very thankfull to you.</span>
